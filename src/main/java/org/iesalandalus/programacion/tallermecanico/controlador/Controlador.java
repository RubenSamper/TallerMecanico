        ...
        try {
            ...
            switch (evento) {
                ...
                case MODIFICAR_CLIENTE ->
                        resultado = (modelo.modificar(vista.leerClieneDni(), vista.leerNuevoNombre(), vista.leerNuevoTelefono())) ? "EL cliente ha sido modificado correctamente." : "EL cliente no ha sido modificado correctamente.";
                ...
                case LISTAR_TRABAJOS_VEHICULOS ->
                        vista.mostrarTrabajos(modelo.getTrabajos(vista.leerMatriculaVehiculo()));
                case SALIR -> terminar();
            }
